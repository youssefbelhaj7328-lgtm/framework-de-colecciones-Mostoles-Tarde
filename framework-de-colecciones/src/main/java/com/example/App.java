...
//List<Persona> listaInmutableDePersona = List.of(persona1,persona1,persona3,persona4, persona5);
		...
		/* Obtener, utilizando Operaciones de Agreagado, el salario promedio
		...
		* no se a notar gran diferencia entre utilizar el metodo stream() o parallelStream() */
		/* las operaciones de agregado conjuntamente con las expresiones lambda , los metodos de la clase Stream
		 * y los metodos por referencia es lo que llama tambien LA PROGRAMACION FUNCIONAL, que unnque java no es un leguaje 
		 * funcional puro
		 * la implementa conjuntamente con la programacion orietada a objetos.
